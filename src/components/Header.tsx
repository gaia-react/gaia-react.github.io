    ...
    >
      ...
      {menuOpen && (
        <div className="gaia-menu-in bg-surface-raised border-line absolute inset-x-0 top-full flex flex-col gap-1 border-b p-4 sm:px-8">
          ...
          <a
            className="text-ink-dim hover:text-accent border-line flex items-center gap-1.5 rounded-sm border-b py-2.5 text-base tracking-[0.02em] whitespace-nowrap no-underline transition-colors duration-150"
            href="https://github.com/gaia-react/gaia"
            rel="noopener noreferrer"
            target="_blank"
          >
