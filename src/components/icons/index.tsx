...
const svgProperties = (size: number, className?: string) => ({
  'aria-hidden': true,
  className,
  height: size,
  viewBox: '0 0 24 24',
...
export const ShieldCheckIcon = ({className, size = 24}: IconProperties) => (
...
// Bullseye. Target with arrow striking the center
export const BullseyeIcon = ({className, size = 24}: IconProperties) => (
  <svg
    aria-hidden={true}
    className={className}
    fill="currentColor"
...
export const MemoryIcon = ({className, size = 24}: IconProperties) => (
  <svg {...svgProperties(size, className)}>
    <rect height="3.4" rx="0.6" width="16.8" x="3.6" y="4.8" />
    <rect height="3.4" rx="0.6" width="16.8" x="3.6" y="10.3" />
    <rect height="3.4" rx="0.6" width="16.8" x="3.6" y="15.8" />
  </svg>
);

// Multi-agent. Three nodes with connecting strokes
export const MultiAgentIcon = ({className, size = 24}: IconProperties) => (
  <svg {...svgProperties(size, className)}>
...
export const ArrowRightIcon = ({className, size = 24}: IconProperties) => (
  <svg {...svgProperties(size, className)}>
    <path d="M4.5 12h14.4" />
...
export const CheckIcon = ({className, size = 24}: IconProperties) => (
  <svg {...svgProperties(size, className)}>
    <path d="m4.8 12.6 4.4 4.4 10-10.4" />
  </svg>
);

export const MinusIcon = ({className, size = 24}: IconProperties) => (
  <svg {...svgProperties(size, className)}>
    <path d="M5 12h14" />
  </svg>
);

export const TildeIcon = ({className, size = 24}: IconProperties) => (
  <svg {...svgProperties(size, className)}>
...
// Warning triangle. Filled triangle outline + exclamation — risk / debt state
export const WarningIcon = ({className, size = 24}: IconProperties) => (
  <svg
    aria-hidden={true}
    className={className}
    fill="currentColor"
