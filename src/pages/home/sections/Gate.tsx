...
const GateLedger = () => (
  <div className="border-line bg-surface overflow-hidden rounded-lg border font-mono text-[0.8rem]">
    <div className="bg-surface-raised border-line flex items-center justify-between border-b px-4 py-2">
      <span className="text-ink-dim text-xs tracking-wider max-sm:hidden">
        .claude/hooks · code-review-audit
      </span>
...
const SupplyChainPanel = () => (
  <div className="border-line bg-surface overflow-hidden rounded-lg border">
    <div className="bg-surface-raised border-line flex items-center justify-between border-b px-4 py-2">
      <span className="text-ink-dim font-mono text-xs tracking-wider max-sm:hidden">
        pnpm-workspace.yaml
      </span>
    ...
    <div className="grid gap-6 p-5 sm:grid-cols-[auto_1fr] sm:items-center sm:gap-8 sm:p-6">
      <div className="flex flex-col">
        <span className="text-accent-soft text-[clamp(2.5rem,6vw,3.5rem)] leading-none tracking-tight">
          7 days
        </span>
  ...
  >
    <div className="mx-auto max-w-6xl">
      ...
      <div className="text-ink-dim max-w-[64ch] space-y-4 text-[1.05rem] leading-[1.65] text-pretty">
        <p>
          A skill is advice. The model can take it or leave it. GAIA leaves no
          such choice.
        </p>
        <p className="max-w-[61ch]">
          Before any change can merge, an automated review reads your exact diff
          for security holes, missing tests, and risky patterns. It fixes what
          it safely can and blocks the merge on what it can’t.
        </p>
        <p className="max-w-[42ch]">
          Every commit clears typecheck, lint, tests, and build first. What
          reaches production is&nbsp;
      ...
      <figure className="mt-12">
        <figcaption className="text-muted mb-3 font-mono text-[0.78rem] tracking-wide">
          The secret never reaches a commit. The untested path never reaches
          main.
        </figcaption>
        <GateLedger />
      </figure>
