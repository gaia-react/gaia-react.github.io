...
const Closing = () => (
  ...
  >
    ...
    <div className="relative mx-auto max-w-[1100px]">
      ...
      <h2
        className="text-ink font-display mb-[1.6rem] text-[clamp(2.6rem,7vw,5rem)] leading-[1.05] font-light tracking-[-0.035em]"
        data-reveal={true}
      ...
      <p
        className="text-ink-dim font-display mb-[2.6rem] text-[clamp(1.1rem,2vw,1.35rem)] italic"
        data-reveal={true}
