...
export default function Hooks() {
  return (
    <Section id="hooks" title="Hooks">
      ...
      <p className="mb-2 text-fg">Protect critical files from unintended edits:</p>
      <ul className="mb-6 ml-4 space-y-1 text-fg">
        <li>
      ...
      <h3 className="mb-3 text-lg font-semibold text-fg">Bash Guards</h3>
      <p className="mb-2 text-fg">Block destructive or expensive operations:</p>
      <ul className="mb-6 ml-4 space-y-1 text-fg">
        <li>
       ...
       <h3 className="mb-3 text-lg font-semibold text-fg">Wiki Management</h3>
       <p className="mb-2 text-fg">Update wiki state across sessions:</p>
       <ul className="mb-6 ml-4 space-y-1 text-fg">
           <li>
           ...
           <li>
               <span className="font-semibold">Keep commits clean</span> - Squash auto-commits from the&nbsp;<a href="https://github.com/AgriciDaniel/claude-obsidian" target="_blank"
                  ...
                  className="text-accent hover:underline">claude-obsidian</a> plugin
           </li>
       </ul>
    </Section>
  );
