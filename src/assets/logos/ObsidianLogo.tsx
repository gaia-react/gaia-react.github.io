...
type ObsidianLogoProperties = Omit<
  SVGProps<SVGSVGElement>,
  'height' | 'width'
> &
  ({height?: never; width?: number} | {height?: number; width?: never});

const ObsidianLogo: FC<ObsidianLogoProperties> = ({
  height,
  width,
  ...properties
}) => {
    ...
    >
      ...
      <g clipPath="url(#obsidian-clip)">
        ...
        <path
          ...
          fill="url(#obsidian-bottom-right)"
        />
